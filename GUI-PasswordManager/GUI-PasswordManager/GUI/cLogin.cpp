...
cLogin::cLogin(wxWindow* parent)
{
     ...
     Text = new wxStaticText(parent, 1, "Password Manager", wxPoint(0, 0), wxSize(300, 45), wxALIGN_CENTER_HORIZONTAL);
     ...
     Input = new wxTextCtrl(parent, 2, "", wxPoint(0, 0), wxSize(100, 20), wxTE_PASSWORD);
     Input->SetFont(inputFont);
     Enter = new wxButton(parent, 3, "Enter", wxPoint(0, 0), wxSize(50, 20));
