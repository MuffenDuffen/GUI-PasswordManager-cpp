...
cLoginPanel::cLoginPanel(wxWindow* parent) : wxPanel(parent, 2)
{
    ...
    Text = new wxStaticText(this, 101, "Password Manager", wxPoint(0, 0), wxSize(300, 45), wxALIGN_CENTER_HORIZONTAL);
    ...
    Enter = new wxButton(this, 301, "Enter", wxPoint(0, 0), wxSize(50, 20));
